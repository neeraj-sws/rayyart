    ...
    <div class="card-body">
        ...
        <div class="modal-body py-3">
            <form class="row g-3" action="{{$route->store}}"
                ...
                <div class="row mt-2">
                    <div class="col-md-10">
                        <label for="Outletname" class="form-label">Category Image</label>
                        <div class="custom-file">
                            <input type="hidden" name="image_path" value="uploads/advertisment/">
                    ...
                    <div class="col-md-2 mt-3">
                        @if($info->image)
                        <img src="{{asset('uploads/advertisment/'.$info->photo->file)}}" id="image_prev"
