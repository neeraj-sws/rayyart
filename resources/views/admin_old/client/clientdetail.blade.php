                            ...
                            <div class="row content-min-height">
                                <div class="p-0 column-panel border-end" style="max-width: 230px; min-width: 230px; left: -230px;">
                                    ...
                                    <div class="columns-panel-item-group">
                                        ...
                                        <a class="columns-panel-item columns-panel-item-link  " id="amenities" onclick="clientdetails('{{ $route->clientservicesdetails}}','{{ $clientProfile->id }}','amenities');return false;" href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                <i class="feather font-size-lg icon-user"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="">
                                                ...
                                                <div class="upload upload-text w-100">
                                                    ...
                                                    <input id="upload" type="file" name="image" class="upload-input" onchange="upload_image($(form),'{{ $route->clientupdateprofiledetails }}','image','file_id');return false;" accept=".jpg,.jpeg,.png">
                                                </div>
                                            </div>
                                            </form>
                                            <div class="col-md">
